    ...
    return buildList {
        add(
            Product(
                ...
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/93/619094/1.jpg?2560"),
                price = 8.9f,
                auction = -1f,
                offer = 10.11f,
                auctionStart = 6110,
        ...
        add(
            Product(
                ...
                title = "Cherry Mayer",
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/77/359744/1.jpg?4978"),
                price = 16.17f,
                auction = -1f,
                offer = 18.19f,
                auctionStart = 8687,
        ...
        add(
            Product(
                ...
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/47/796613/1.jpg?7826"),
                price = 32.33f,
                auction = -1f,
                offer = 34.35f,
                auctionStart = 6303,
        ...
        add(
            Product(
                ...
                productCode = "expetenda",
                title = "Amelia Lewis",
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/74/956483/1.jpg?9747"),
                price = 40.41f,
                auction = -1f,
                offer = 42.43f,
                auctionStart = 1155,
        ...
        add(
            Product(
                ...
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/40/357284/1.jpg?5906"),
                price = 48.49f,
                auction = -1f,
                offer = 50.51f,
                auctionStart = 9625,
        ...
        add(
            Product(
                ...
                title = "Stephen Ewing",
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/18/313084/1.jpg?0214"),
                price = 56.57f,
                auction = -1f,
                offer = 58.59f,
                auctionStart = 3306,
        ...
        add(
            Product(
                ...
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/77/491602/1.jpg?1949"),
                price = 64.65f,
                auction = -1f,
                offer = 66.67f,
                auctionStart = 3883,
        ...
        add(
            Product(
                ...
                imageUris = arrayOf("https://eg.jumia.is/unsafe/fit-in/680x680/filters:fill(white)/product/22/411581/1.jpg?9349"),
                price = 72.73f,
                auction = -1f,
                offer = 74.75f,
                auctionStart = 1490,
