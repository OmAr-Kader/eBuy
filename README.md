...
### Story 5.2: Payment Access Layer
- Task 5.2.1: Implement Unverified Payment designs
- Task 5.2.2: Implement Payment methods validation
- Task 5.2.3: Write tests for checkout

## Epic 6: UX
### Story 6.1: User Confirmations Layer 
- Task 6.1.1: Implement user confirmation screens design
- Task 6.1.2: Implement user confirmation functionality
- Task 6.1.3: Write tests for checkout
### Story 6.2: User Interaction Layer
- Task 6.2.1: Create database schema for interactions
  - [Interaction](https://github.com/OmAr-Kader/eBuy/tree/master/shared/src/commonMain/kotlin/com/ramo/ebuy/data/dataSources/interaction)
- Task 6.2.2: Implement user interactions functionality
- Task 6.2.3: Write tests for interaction
